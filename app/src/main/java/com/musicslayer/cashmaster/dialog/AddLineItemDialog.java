...
public class AddLineItemDialog extends BaseDialog {
    ...
    public void createLayout(Bundle savedInstanceState) {
        ...
        PlainTextEditText E_NAME = findViewById(R.id.add_line_item_dialog_nameEditText);
        AmountEditText E_AMOUNT = findViewById(R.id.add_line_item_dialog_amountEditText);
